                ...
                <div class="icon-close" >
                    ...
                    <div class="test">
                        ...
                        <div class="login-form">
                            <!-- form dang ky -->
                            <form id="sign_in" method="POST" action="<?php echo e(route('register-account')); ?>">
                            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                <div class="form-group row">
                                    <label for="full_name" class="col-3 col-form-label">Họ tên</label>
                                    <input type="text" class="form-control col-9 login-input" value="<?php echo e(old('full_name')); ?>" id="full_name"
                    ...
                    <?php endif; ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control col-9 login-input" value="<?php echo e(old('full_name')); ?>" id="phone"
                    ...
                    <?php endif; ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control col-9 login-input" value="<?php echo e(old('full_name')); ?>" id="email" name="email"
                    ...
                    <?php endif; ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="password" class="form-control col-9 login-input" value="<?php echo e(old('full_name')); ?>" id="password"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row" style="margin-left: 10px;">
                                        <div class="form-check-inline gender-check">
                                            <input class="form-check-input" <?php echo 'male'==old('gender') ? 'checked': '' ?> type="radio" name="gender" value="male"
                                                checked>
                                            <label class="form-check-label" for="gender">Nam</label>
                                        </div>
                                        <div class="form-check-inline gender-check">
                                            <input class="form-check-input" <?php echo 'female'==old('gender') ? 'checked': '' ?> type="radio" name="gender" value="female">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="dropdown col-3">
                                         ...
                                         <?php $number = $i<10 ? '0'.$i : $i; ?> 
                                           <option <?php echo $i==old('day') ? 'selected': '' ?> ><?php echo e($number); ?></option>
                                           <?php endfor; ?>
                                         </select>
                                    </div>
                                    <div class="dropdown col-3">
                                    ...
                                    <div class="dropdown col-3">
                                        <select name="year" class="form-control form-control-sm">
                                         <?php for($i=1960;$i<=date('Y');$i++): ?>
                                           <option <?php echo $i==old('day') ? 'selected': '' ?>><?php echo e($i); ?></option>
                                           <?php endfor; ?>
                                         </select>
                                    </div>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-7 log-right">
                    ...
                    <div class="test">
                        ...
                        <!-- form dang nhap -->
                        <div class="login-form">
                           <form method="POST" action="<?php echo e(route('loginCustomerAction')); ?>">
               <?php echo e(csrf_field()); ?>
                                ...
                                <div class="form-group row">
                                    <div class="col-3"></div>
                                    <div class="col-9 log-right-item">
                                        <p class="forgot-password">Quên mật khẩu? Nhấn vào <a href="<?php echo e(route('forgetPassword')); ?>"> đây</a>
                                        </p>
...
<footer class="footer">
   ...
   <?php if(URL::current()!=route('forgetPassword')): ?>:
    <?php if($errors->any()): ?>
...
</html><?php /**PATH C:\xampp\htdocs\Lap-Trinh-Web-Team-Official\resources\views/common/footer.blade.php ENDPATH**/ ?>