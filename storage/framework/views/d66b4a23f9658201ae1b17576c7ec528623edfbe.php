    	        	...
    	        	<div class="card">
    		          	...
    		          	<div class="card-body">
                            ...
                            <div class="form-group hidden">
                                ...
                                <input type="text" name="product_code" id="product_code" value="<?php echo e($product_code); ?>" class="form-control">
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="price_origin" class="title_txt">Giá gốc</label>
                                    <input type="text" name="price_origin" id="price_origin" value="<?php echo e($price_origin); ?>" class="form-control">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="price_promotion" class="title_txt">Giá khuyến mãi</label>
                                    <input type="text" name="price_promotion" id="price_promotion" value="<?php echo e($price_promotion); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="form-row hidden">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group date" id="start_event" data-target-input="nearest">
                                        <input type="text" name="start_event" class="form-control datetimepicker-input" data-target="#start_event" value="<?php echo e($start_event); ?>">
                                ...
                                <div class="form-group col-md-6 hidden">
                                    ...
                                    <div class="input-group date" id="end_event" data-target-input="nearest">
                                        <input type="text" name="end_event" class="form-control datetimepicker-input" data-target="#end_event" value="<?php echo e($end_event); ?>">
                            ...
                            <div class="form-group hidden">
                                ...
                                <input type="text" name="product_detail_weight" id="product_detail_weight" value="<?php echo e($product_detail_weight); ?>" class="form-control">
                            </div>
                            <div class="form-group hidden">
                                <label for="product_detail_source" class="title_txt">Xuất xứ</label>
                                <input type="text" name="product_detail_source" id="product_detail_source" value="<?php echo e($product_detail_source); ?>" class="form-control">
                            </div>
                            <div class="form-group hidden">
                                <label for="product_detail_size" class="title_txt">Size</label>
                                <input type="text" name="product_detail_size" id="product_detail_size" value="<?php echo e($product_detail_size); ?>" class="form-control">
                            </div>
                            <div class="form-group hidden">
                                <label for="product_expiry_date" class="title_txt">Hạn sử dụng</label>
                                <input type="text" name="product_expiry_date" id="product_expiry_date" value="<?php echo e($product_expiry_date); ?>" class="form-control">
                            </div>
                            <div class="form-group hidden">
                                <label for="post_order" class="title_txt">Thành phần</label>
                                <textarea name="product_detail_ingredients" id="product_detail_ingredients" rows="10" class="mceEditor form-control mce" placeholder="Thành phần sản phẩm"><?php echo $product_detail_ingredients; ?></textarea>
                            </div>
                            <div class="form-group hidden">
                                <label for="post_order" class="title_txt">Sắp xếp (Số càng lớn thứ tự càng cao)</label>
                                <input type="text" name="post_order" id="post_order" value="<?php echo e($post_order); ?>" class="form-control">
                            </div>
                            <div class="form-group hidden">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group hidden">
                                ...
                                <input type="text" class="form-control" id="post_thumb_alt" value="<?php echo e($thumbnail_alt); ?>" name="post_thumb_alt" placeholder="Thumbnail Alt">
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        ...
                                        <input type="text" name="thumbnail_file_link" class="custom-file-link form-control" id="thumbnail_file_link" value="<?php echo e($thumbnail); ?>">
                                        <label class="custom-file-label custom-file-label-thumb" for="thumbnail_file"></label>
                                    </div>
                                </div>
                                <?php if($thumbnail != ""): ?>
                                <div class="demo-img" style="padding-top: 15px;">
                                    <img src="<?php echo e(asset('images/product/'.$thumbnail)); ?>">
                                </div>
                                <?php endif; ?>
                            </div>
                        </div> <!-- /.card-body -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lap-Trinh-Web-Team-Official\resources\views/admin/product/single.blade.php ENDPATH**/ ?>