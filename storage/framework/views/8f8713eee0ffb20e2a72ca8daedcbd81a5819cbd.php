...
<div class="header-bottom">
    <div style="position:relative;display:flex;align-items:center;justify-content:space-between;height:40px"
        ...
        <div class="wishlist"><a class="" href="<?php echo e(route('wishList.show')); ?>"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"></path>
        </svg><span>Sản phẩm yêu thích</span></a></div>
...
</div><?php /**PATH C:\xampp\htdocs\Lap-Trinh-Web-Team-Official\resources\views/common/header-bottom.blade.php ENDPATH**/ ?>