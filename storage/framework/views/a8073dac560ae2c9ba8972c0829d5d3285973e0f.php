...
">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item hidden">
            <a href="<?php echo e(route('admin.listBrand')); ?>" class="nav-link <?php if(in_array($segment_check, array('list-brand', 'brand'))){ echo 'active'; } ?>">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('admin.revenue')); ?>" class="nav-link <?php if(in_array($segment_check, array('list-order', 'order'))){ echo 'active'; } ?>">
    ...
    <!-- /.sidebar -->
  </aside><?php /**PATH C:\xampp\htdocs\Lap-Trinh-Web-Team-Official\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>