                ...
                $(function() {
                    ...
                    $('#users-table').DataTable({
                        ...
                        {//action
                            ...
                            className: "text-center",
                            render: function (data, type, full, meta) {
                                return '<div class="group-action"><a id="showBtn" class="btn btn-info show" href="{{url()->current()}}/' + full.id + '">Show</a><a id="deleteBtn" href="{{url()->current()}}/delete/' + full.id + '" class="btn btn-danger delete" name="deleteBtn" type="button" >Delete</a></div>';
                            }
                        }
                    ],
                    });
