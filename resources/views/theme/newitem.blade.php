...
@section('seo')
<?php
	$title='Sản phẩm mới | '.Helpers::get_option_minhnn('seo-title-add');;
                    	...
                    	<div class="leftContent col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="row-content-category clear">
                                <div class="listProduct box clear">
                                    <div class="container_theme_category title_search_box clear">
                                        <h1 class="title_product">SẢN PHẨM MỚI</h1>
                                    </div>
                                    ...
                                    <div class="list_theme_category product_category_container clear">
                                        @if(count($data_customers)>0)
                                            <div class="row row-listpro flex wrap">
                                                ...
                                                ?>
                                              <div id="theme_cate_{{$k}}" class="item_product_list product_item_list col col-lg-5ths item-page-category-product" data-open="0" data-id="{{$data_customer->id}}" >
