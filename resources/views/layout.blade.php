		...
		<div class="container">
			<div class="row">
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									<li><a href="#"> <span class="pull-right">(50)</span>KHÔNG CẦN LÀM KAKA</a></li>
				...
				<div class="col-sm-9 padding-right">
							...
							{{-- GỌI NỘI DUNG TỪ SECTION('CONTENT') CỦA TRANG HOME --}}
							@yield('content')
	...
	<script>
		$(document).ready(function(){
			$('.add-to-cart').click(function(){
				...
				var cart_product_id = $('.cart_product_id_' + id).val(); //trong jquery nối chuỗi là + không phải .
				...
				$.ajax({
					...
					success:function(data){
						swal({
							...
							text: "Bạn có thể mua hàng tiếp hoặc thanh toán ngay",
