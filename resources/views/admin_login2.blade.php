                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="{{URL::to('/admin-dashboard')}}" method="post" class="user">
                                        ...
                                        <div class="form-group">
                                            <input  type="password" name="admin_email" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Password">
                                        </div>
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                <input type="checkbox" name="admin_password" class="custom-control-input" id="customCheck">
