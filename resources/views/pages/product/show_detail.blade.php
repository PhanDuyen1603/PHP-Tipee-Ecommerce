              ...
              <!-- Wrapper for slides -->
                <div class="carousel-inner">
                    <div class="item active">
                      <a href=""><img src="{{URL::to('/public/uploads/product/'.$detail->product_image)}}" alt=""></a>
                    </div>                    
                </div>
    ...
    <div class="col-sm-7">
        <div class="product-information"><!--/product-information-->
            ...
            <form action="{{URL::to('/save-cart')}}" method="POST">
                {{csrf_field()}}
                <span>
                    <span>{{number_format($detail->product_price).' đ'}}</span>
                    <label>Quantity:</label>
                    <input name="qty" type="number" min="1" value="1" />
                    <input name="productId_hidden" value="{{($detail->product_id)}}" type="hidden">
...
<div class="recommended_items"><!--recommended_items-->
    ...
    <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="item active">	
                @foreach($relatedProducts as $key => $rel)
                <div class="col-sm-4">
