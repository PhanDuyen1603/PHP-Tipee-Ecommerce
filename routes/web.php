...
//WISHLIST
Route::post('/save-wishList','Frontend\ProductController@save_wishList')->name('wishList.save');
Route::get('/show-wishList','Frontend\ProductController@show_wishList')->name('wishList.show');
